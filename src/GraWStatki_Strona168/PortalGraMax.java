...
public class PortalGraMax {
    ...
    private void przygotujGre() {
        ...
        System.out.println("Postaraj się je zatoopić  jak najmniejszej ilości ruchów");

        for (Portal rozmieszczanyPortal : listaPortali) {
            ArrayList<String> nowePolozenie = pomocnik.rozmiescPotal(3);
    ...
    private void zakonczGre() {
        ...
        if (iloscRuchow <= 18) {
            ...
            System.out.println("Wydoostałeś się zanim Twoje informacje zatoneły.");
        } else {
            System.out.println("Ale się grzebałeś! Wykonałes aż " + iloscRuchow + " ruchów. ");
            System.out.println("Teraz rybki pywają pomiędzy Twoimi informacjami. ");
        }
    }
